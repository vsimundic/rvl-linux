...
def generate_cabinet_urdf_from_door_panel(w, h, d, save_path):
    # w = 0.3
    # h = 0.5
    # d = 0.018
    static_d = 0.3
...
if __name__ == '__main__':
    generate_cabinet_urdf_from_door_panel(0.3, 0.5, 0.018, '/home/RVLuser/ur5_robotiq3f_gazebo_ws/src/ur5_robotiq3f_moveit_config/cabinet_models/my_cabinet/my_cabinet_test.urdf')
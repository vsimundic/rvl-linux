...
if("TRUE" STREQUAL "TRUE")
  set(robotiq_modbus_rtu_SOURCE_PREFIX /home/RVLuser/ferit_ur5_ws/src/ur5_configs/robotiq-noetic-devel/robotiq_modbus_rtu)
  set(robotiq_modbus_rtu_DEVEL_PREFIX /home/RVLuser/ferit_ur5_ws/devel)
  ...
  set(robotiq_modbus_rtu_INSTALL_PREFIX /home/RVLuser/ferit_ur5_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/RVLuser/ferit_ur5_ws/src/ur5_configs/robotiq-noetic-devel/robotiq_modbus_rtu/${idir}'.  ${_report}")
    endif()

...
if("TRUE" STREQUAL "TRUE")
  set(ur_gazebo_SOURCE_PREFIX /home/RVLuser/ferit_ur5_ws/src/ur5_configs/fmauch_universal_robot/ur_gazebo)
  set(ur_gazebo_DEVEL_PREFIX /home/RVLuser/ferit_ur5_ws/devel)
  ...
  set(ur_gazebo_INSTALL_PREFIX /home/RVLuser/ferit_ur5_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/RVLuser/ferit_ur5_ws/src/ur5_configs/fmauch_universal_robot/ur_gazebo/${idir}'.  ${_report}")
    endif()

...
"      write_output_integer_reg(2, value)" + NEW_LINE  + 
"    end" + NEW_LINE  + 
"" + NEW_LINE  + 
"    def signal_async_operation_started():" + NEW_LINE  + 
"      write_output_integer_reg(2, 0) # 0 indicates operation started" + NEW_LINE  + 
"    end" + NEW_LINE  + 
"" + NEW_LINE  + 
...
"      end" + NEW_LINE  + 
"      write_output_integer_reg(2, async_finished) # negative values indicate operation finished" + NEW_LINE  + 
"    end" + NEW_LINE  + 
"" + NEW_LINE  + 
...
"        speedl(speed_wrt_base, 0.5)" + NEW_LINE  + 
"      end" + NEW_LINE  + 
"    end" + NEW_LINE  + 
"" + NEW_LINE  + 
...
"            deceleration_rate = read_input_float_reg(0)" + NEW_LINE  + 
"            async = read_input_integer_reg(1)" + NEW_LINE  + 
"            textmsg("+QUOTATION+"stopl async="+QUOTATION+", async)" + NEW_LINE  + 
"            stop_async_move()" + NEW_LINE  + 
"            if async == 1:" + NEW_LINE  + 
"                enter_critical" + NEW_LINE  + 
...
"            deceleration_rate = read_input_float_reg(0)" + NEW_LINE  + 
"            async = read_input_integer_reg(1)" + NEW_LINE  + 
"            textmsg("+QUOTATION+"stopj async="+QUOTATION+", async)" + NEW_LINE  + 
"            stop_async_move()" + NEW_LINE  + 
"            if async == 1:" + NEW_LINE  + 
"                enter_critical" + NEW_LINE  + 
"                stop_type = 0" + NEW_LINE  + 
"                stop_dec = deceleration_rate" + NEW_LINE  + 
"                exit_critical" + NEW_LINE  + 
"                stop_thrd = run stop_thread()" + NEW_LINE  + 
"            else:" + NEW_LINE  + 
...
"              jog_custom_feature = pose_from_input_float_registers(7)" + NEW_LINE  + 
...
"        ###################################" + NEW_LINE  + 
"" + NEW_LINE  + 
"        textmsg("+QUOTATION+"RTDE Control Script Loaded (13.10.2021-13:55)"+QUOTATION+")" + NEW_LINE  + 
"" + NEW_LINE  + 

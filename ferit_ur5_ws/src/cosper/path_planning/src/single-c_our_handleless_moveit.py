...
if __name__ == '__main__':
    ...
    while i < num_doors:
        ...
        try:
            ...
            # RVL path planning
            T_G_0_array, q, all_feasible_paths, all_feasible_paths_q = rvl_path_planning(rvl_cfg, T_R_W, q_init, 1, True, cabinet_model, state_angle)
            ...
            if T_G_0_array.shape[0] == 1:
                ...
                path_found = True
                mask = all_feasible_paths[:, 3, 3, 3] > 0.5 # check if last element in transformation matrix is 1
                ...
                for i_q in range(n_path_points):
                    q_, _ = robot.get_inverse_kin_builtin(q_temp, T_T_0_path[i_q, :, :])
                ...
                trajectory_successful = robot.send_multiple_joint_space_poses_to_robot2(q_path)

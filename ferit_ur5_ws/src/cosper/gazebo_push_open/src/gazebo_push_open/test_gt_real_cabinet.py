...
if __name__ == '__main__':
	...
	save_path = '/home/RVLuser/ferit_ur5_ws/src/cosper/gazebo_push_open/config/real_robot/Exp-cabinet_open-20240222/'
	...
	# i = 0
	# while i < 2:
	# 	key = input('Press \'p\' to save first tool pose: ')
	# 	if key == 'p':
	...
	config_path = '/home/RVLuser/ferit_ur5_ws/src/a_demo/config/gt_real_cabinet_config.yaml'

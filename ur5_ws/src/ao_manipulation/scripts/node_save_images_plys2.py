...
class ImageSaver():
    def __init__(self, args):
        ...
        self.build_model_pub = rospy.Publisher('/build_model2', Bool, queue_size=1)
        ...
        self.cfg_path = rospy.get_param('/rvl_cfg_path')
        self.rgb_save_path = rospy.get_param('/rgb_save_path')
        self.depth_save_path = rospy.get_param('/depth_save_path')
        self.ply_save_path = rospy.get_param('/ply_save_path')
    ...
    def callback(self, rgb_msg, depth_msg, camera_info_msg):
        ...
        if self.space_pressed == 2:
            ...
            ao = self.detect_model(self.cfg_path, self.rgb_save_path, self.depth_save_path, self.ply_save_path)
            print(ao)
    ...
    def detect_model(self, cfg_path, rgb_save_path, depth_save_path, ply_save_path):

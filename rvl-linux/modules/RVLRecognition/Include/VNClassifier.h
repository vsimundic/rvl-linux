...
namespace RVL
{
    ...
    public:
        ...
        void DetectSupportingSurfaces(Mesh *pMesh);
    ...
    public:
        ...
        bool b3DNetVOI;
        bool bBoundingBoxes;
        bool bDetectSupportingSurfaces;
        bool bGndConstraint;
        ...
        bool bLabelsAssignedToUnassignedPoints;
        ...
        FILE *fpDebug;
        float timeInterpret;
        ConvexTemplateLookUpTable convexTemplateLUT;
